...
namespace LibraryServices
{
    public class CheckoutService : ICheckout
    {
        ...
        public void MarkFound(int assetId)
        {
            ...
            UpdateAssetStatus(assetId, StatusNames.Available);
        ...
        {
            UpdateAssetStatus(assetId, StatusNames.Lost);
        ...
        private void CheckoutToEarliestHold(int assetId, IQueryable<Hold> currentHolds)
        {
            var earliestHold = currentHolds
                 .OrderByDescending(holds => holds.HoldPlaced)
                 .FirstOrDefault();
        ...
        {
            if (IsCheckouted(assetId))
            {
                //add code to handle feedback to the user
                return;
            }
            ...
            _context.Update(item);
            UpdateAssetStatus(assetId, StatusNames.CheckedOut);
        ...
        public void PlaceHold(int assetId, int libraryCardId)
        {
            ...
            {
                UpdateAssetStatus(assetId, StatusNames.OnHold);
            }
        ...
        public bool IsCheckouted(int assetId)
        {
            return _context.Checkouts
